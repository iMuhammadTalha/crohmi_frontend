(function ($) {
    ...
    $(document).ready(function () {
        ...
        $("#GoButton").on("click", function () {
            ...
            //Sales chart
            $.ajax({
                url: "http://111.68.101.17:8000/api/crohmi/reading/?action=last_thirty_days&node1=" + polNo1 + "&node2=" +
                    polNo2 + "&selectedDate=" + selectedDate,
                type: "get",
                success: function (response) {
                    ...
                    $("#sales-chart-div").append('<h4 class="mb-3">Last 30 days comparison grouped by 1 day interval from selected date</h4><canvas height="150px" id="sales-chart"></canvas>');
            ...
            $.ajax({
                url: "http://111.68.101.17:8000/api/crohmi/reading/?action=last_three_months&node1=" + polNo1 + "&node2=" +
                    polNo2 + "&selectedDate=" + selectedDate,
                type: "get",
                success: function (response) {
                    var temp = [];
                    ...
                    //bar chart
                    $("#barChart-div").empty();
                    $("#barChart-div").append('<h4 class="mb-3">Last 3 months comparison grouped by 10 days interval from selected date</h4><canvas height="150px" id="barChart"></canvas>');
