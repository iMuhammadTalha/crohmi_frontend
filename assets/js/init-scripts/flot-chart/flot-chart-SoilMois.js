(function ($) {
    ...
    var SufeeAdmin = {
        ...
        cpuLoad: function (pn) {
            ...
            $.ajax({
                url: "http://111.68.101.17:8000/api/crohmi/reading/?action=node&node=" + pn,
                type: "get",
                success: function (response) {
                    for (var counter = 0; counter < response.length; counter++) {
                        data.push([counter + 1, response[counter]["soil_moisture"]]);
                    }
                }
            });
        ...
        barFlot: function () {
            ...
            $.ajax({
                url: "http://111.68.101.17:8000/api/crohmi/reading/?action=last_seven_days" + "&selectedDate=" + selectedDate,
                type: "get",
                success: function (response) {
                    var d1 = [];
                    for (var counter in response) {
                        var obj = response[parseInt(counter)];
                        d1.push([new Date(obj["datetime"]), obj["soil_moisture"]]);
                    }
        ...
        plotting: function () {
            ...
            $.ajax({
                url: "http://111.68.101.17:8000/api/crohmi/reading/?action=last_day" + "&selectedDate=" + selectedDate,
                type: "get",
                success: function (response) {
                    var d1 = [];
                    for (var counter in response) {
