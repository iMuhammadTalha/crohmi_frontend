    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="row">
                ...
                <form  action="tables-dataview.php" method="GET">
                <div class="col-sm-4">
                Starting date:
            ...
            <div class="row">
                ...
                <script type="text/javascript">
                    ...
                    setTimeout(function() {
                        $.ajax({
                        url: "http://111.68.101.17:8000/api/crohmi/reading/?action=table-view&start_date=" +
            ...
            <!-- <div style="margin:auto; padding-bottom:12px" class="col-lg-12"><form  action="tables-dataview.php" method="GET">
						Start date:
