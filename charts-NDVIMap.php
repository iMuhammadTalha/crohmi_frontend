        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
            		<div class="container">
						...
						<div class="form-group">
						<label for="ndviYear">Enter Year</label>
						<input type="number" class="form-control" name="ndviYear" id="ndviYear" min="2018" max="2050" required>
						...
						<div class="form-group">
  							<label for="ndviCat">Select Category</label>
							<select class="form-control" name="ndviCat" id="ndviCat">
