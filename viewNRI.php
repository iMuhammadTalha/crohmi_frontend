...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		$images = scandir("images/uploads/nir/", 1);
				...
				<div id="collapse'.$Num[$i].'" class="collapse" aria-labelledby="heading'.$Num[$i].'" data-parent="#accordionExample">
				  ...
				  foreach ($images as $key => $val) {
					   if (strstr($val,$Months[$i])){
							...
							<img width="90%" style="float:left; margin: 5% 5% 0% 5%;" src="images/uploads/nir/'.$val.'"></img>
							<div style="clear:left"></div><div style="background:rgba(0,0,0,0.1); margin:0% 5% 5% 5%; padding:4px; text-align:center; font-size:22px;"><Button style = "margin: 5px" onclick=\'downloadFile("'."images/uploads/nir/".$val.'")\'>View</Button><Button style = "margin: 5px" ><a href="'."images/uploads/nir/".$val.'" download>Download</a></Button></div>
							</div>';;
					   }
					}
					echo '</div>
