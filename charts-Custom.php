						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<select name="param1" id="param1" class="form-control">
									...
									<option selected value="air_moisture">Humidity</option>
                    ...
                    <div class="col-lg-6">
                        <div class="card" id="CustLine">
                            <div class="card-body" id="sales-chart-div">
                                <h4 class="mb-3">Last 30 days comparison grouped by 1 day interval from selected date</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="card" id="CustBar">
                            <div class="card-body" id="barChart-div">
                                <h4 class="mb-3">Last 3 months comparison grouped by 10 days interval from selected date</h4>
